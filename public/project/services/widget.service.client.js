(function () {
    ...
    function widgetService($http) {
        ...
        function findAllWidgetsForPage(pageId) {
            var url = "/api/petStory/page/" + pageId + "/widget";
            return $http.get(url)
        ...
        function findWidgetById(widgetId) {
            var url = "/api/petStory/widget/" + widgetId;
            return $http.get(url)
                .then(function (response) {
                    return response.data;
                })
        ...
        function reorderWidgets(pageId,index1,index2) {
            var url = '/api/petStory/page/' + pageId + '/widget?initial=' + index1 + '&final=' + index2;
            return $http.put(url)
                .then(function (response) {
                    return response.data;
                })
        ...
        function updateFlickr(pageId,widgetId,urlObject) {
            var url = '/api/petStory/flickr/' + pageId + '/' +widgetId;
